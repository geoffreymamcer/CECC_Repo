...
const APPOINTMENT_LOADING_DURATION = 500; // 1.5 seconds
                  ...
                  <div>
                    ...
                    <div className="mt-6 bg-blue-50 p-4 rounded-lg border border-blue-100 flex items-start">
                      ...
                      <p className="text-sm text-blue-800">
                        Your appointment request will be confirmed within 24
                        hours. You'll receive a confirmation email with all the
                        details.
                      </p>
                    </div>
                  </div>
